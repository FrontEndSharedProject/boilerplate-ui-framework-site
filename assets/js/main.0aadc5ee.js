...
/* harmony default export */ var routes = ([{path:'/blog/archive',component:exports_ComponentCreator('/blog/archive','f4c'),exact:true},{path:'/docs',component:exports_ComponentCreator('/docs','97a'),routes:[{path:'/docs/advance/build',component:exports_ComponentCreator('/docs/advance/build','56a'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/advance/config',component:exports_ComponentCreator('/docs/advance/config','31d'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/advance/deploy',component:exports_ComponentCreator('/docs/advance/deploy','89f'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/advance/mdx',component:exports_ComponentCreator('/docs/advance/mdx','cfa'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/advance/standard',component:exports_ComponentCreator('/docs/advance/standard','7c0'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/advance/use-as-a-package',component:exports_ComponentCreator('/docs/advance/use-as-a-package','efa'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/components/card',component:exports_ComponentCreator('/docs/components/card','295'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/components/icons',component:exports_ComponentCreator('/docs/components/icons','539'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/intro',component:exports_ComponentCreator('/docs/intro','99a'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/paths/create-a-component',component:exports_ComponentCreator('/docs/paths/create-a-component','611'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/paths/use-image',component:exports_ComponentCreator('/docs/paths/use-image','2be'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/paths/use-link',component:exports_ComponentCreator('/docs/paths/use-link','1bc'),exact:true,'sidebar':"tutorialSidebar"},{path:'/docs/paths/use-remote-source',component:exports_ComponentCreator('/docs/paths/use-remote-source','803'),exact:true,'sidebar':"tutorialSidebar"}]},{path:'/',component:exports_ComponentCreator('/','deb'),exact:true},{path:'*',component:exports_ComponentCreator('*')}]);
...
var globalData_namespaceObject = JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/docs","mainDocId":"intro","docs":[{"id":"advance/build","path":"/docs/advance/build","sidebar":"tutorialSidebar"},{"id":"advance/config","path":"/docs/advance/config","sidebar":"tutorialSidebar"},{"id":"advance/deploy","path":"/docs/advance/deploy","sidebar":"tutorialSidebar"},{"id":"advance/mdx","path":"/docs/advance/mdx","sidebar":"tutorialSidebar"},{"id":"advance/standard","path":"/docs/advance/standard","sidebar":"tutorialSidebar"},{"id":"advance/use-as-a-package","path":"/docs/advance/use-as-a-package","sidebar":"tutorialSidebar"},{"id":"components/card","path":"/docs/components/card","sidebar":"tutorialSidebar"},{"id":"components/icons","path":"/docs/components/icons","sidebar":"tutorialSidebar"},{"id":"intro","path":"/docs/intro","sidebar":"tutorialSidebar"},{"id":"paths/create-a-component","path":"/docs/paths/create-a-component","sidebar":"tutorialSidebar"},{"id":"paths/use-image","path":"/docs/paths/use-image","sidebar":"tutorialSidebar"},{"id":"paths/use-link","path":"/docs/paths/use-link","sidebar":"tutorialSidebar"},{"id":"paths/use-remote-source","path":"/docs/paths/use-remote-source","sidebar":"tutorialSidebar"}]}]}}}');
